...
```{r}
set.seed(100)
test_ind = sample(1:nrow(SD2NA1), size = 5)
SD2NA_train = SD2NA1[-test_ind, ]
SD2NA_test = SD2NA1[test_ind, ]
```

```{r}
SD2NA_train1 <- as(SD2NA_train, "realRatingMatrix")
```

```{r}
library(recommenderlab)
recc_model = Recommender(data = SD2NA_train1, method = "IBCF", parameter = list(k = 26))
recc_model
```
