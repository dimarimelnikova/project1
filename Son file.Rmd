...
```{r}
antitop = head (arrange(SD2NANA112, sum), 20)
antitop$iid
```
```{r}
SDFlike7_1 = filter(SDFdec, iid == c(198, 302, 529, 437, 197, 213, 88, 201,  34,  35, 133, 256, 430, 324,  65, 142, 144, 180, 183, 323) )
```


```{r}
#SD22NA1 = filter(SD22NA, iid = antitop$iid )
```
